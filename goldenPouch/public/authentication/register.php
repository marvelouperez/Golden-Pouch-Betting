...
if(isset($_POST['registerBtn'])){
    ...
    if($user->saveUser($username, $password, $email)){
        header("Location: /public/authentication/login");
    }else{
        header("Location: /");
    }
} 
                        ...
                        <div class="card-body p-md-5">
                            <div class="row justify-content-center">
                                <div class="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1">
                                    ...
                                    <form method="POST" action="/public/authentication/register" class="mx-1 mx-md-4">
                                        ...
                                        <button name="registerBtn" type="submit" class="btn btn-outline-light btn-lg">Register</button>
                                        </div>
                                ...
                                <div class="col-md-10 col-lg-6 col-xl-7 d-flex align-items-center order-1 order-lg-2"
                                    ...
                                    <img src="/public/assets/img/ESports-betting.png" class="img-fluid" alt="Sample image"
