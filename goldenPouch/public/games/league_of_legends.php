...
<div class="col-xxl-8 px-4 py-5 hero-section-2" style="border-radius: 10px 10px 10px 10px;">
    <iframe width="1100" height="400" src="https://www.youtube.com/embed/pFt-MyYlrLI?autoplay=1&mute=1"
...
<div class="container betting-table">
    <div class="card text-white bg-dark">
        <div class="card-header" style="font-size:xx-large">
            <h1>TT vs OMG | LNG vs UP </h1>
            LPL SUMMER SPLIT 2022
        </div>
    </div>
</div>
    ...
    <div class="container" style="margin-top: 20px">
        <div class="row" style="text-align:center">
            <div class="col-4" style="font-size: xx-large">
                <div class="card text-white border-success bg-dark shadow-lg">
                    <div class="card-body">
                        <h5 class="card-title">Round 1</h5>
                        <a href="#" class="btn btn-outline-light">TT | 1.14</a>
                        <a href="#" class="btn btn-outline-light">OMG | 3.62</a>
                    </div>
                </div>
            </div>
            <div class="col-4" style="font-size: xx-large">
        ...
        <div class="row" style="text-align:center">
            <div class="col-4" style="font-size: xx-large">
                <div class="card text-white border-success bg-dark shadow-lg">
                    <div class="card-body">
                        <h5 class="card-title">Round 1</h5>
                        <a href="#" class="btn btn-outline-light">LNG | 1.14</a>
                        <a href="#" class="btn btn-outline-light">UP | 3.62</a>
                    </div>
                </div>
            </div>
            <div class="col-4" style="font-size: xx-large">
