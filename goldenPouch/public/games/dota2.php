...
<div class="col-xxl-8 px-4 py-5 hero-section-2" style="border-radius: 10px 10px 10px 10px;">
    <iframe width="1100" height="400" src="https://www.youtube.com/embed/lt5QwqdNLFM?autoplay=1&mute=1"
...
<div class="container betting-table">
    <div class="card text-white bg-dark">
        ...
        <h1>TNC Predator vs Army Geniuses</h1>
            ESL ONE Malaysia 2022 Southeast Asia: Open Qualifier #1
        </div>
    </div>
</div>
            ...
            <div class="col-4" style="font-size: xx-large">
                <div class="card text-white border-success bg-dark shadow-lg">
                    <div class="card-body">
                        ...
                        <a href="#" class="btn btn-outline-light">TNC Predator | 1.14</a>
                        <a href="#" class="btn btn-outline-light">Army Geniuses | 3.62</a>
                    </div>
                </div>
            </div>
            <div class="col-4" style="font-size: xx-large">
